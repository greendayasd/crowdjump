(function () {
        ...
        QuestionnaireController.$inject = ['$scope', 'Authentication', 'Questionnaire', 'Ideas', 'Comments', 'History'];

        function QuestionnaireController($scope, Authentication, Questionnaire, Ideas, Comments, History) {
            var vm = this;
